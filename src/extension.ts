...
export function runCommand(commandLabel: string) {
  ...
  editor
    ...
    .then(() => {
      ...
      const lineRunningOffsets = lodash
        .uniq(sortedActions.map((s) => s.range.end.line))
...
export function activate(context: vscode.ExtensionContext) {
  ...
  vscode.commands.registerCommand(
    "extension.changeCaseExtends.camelCase",
  ...
  vscode.commands.registerCommand(
    "extension.changeCaseExtends.kebabCase",
  ...
  vscode.commands.registerCommand(
    "extension.changeCaseExtends.pathCase",
  ...
  vscode.commands.registerCommand(
    "extension.changeCaseExtends.snakeCase",
    () => runCommand(COMMAND_LABELS.snakeCase)
  );
  vscode.commands.registerCommand(
    "extension.changeCaseExtends.trainCase",
